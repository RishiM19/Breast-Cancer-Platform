...
def calculate_class_weights(train_loader):
    ...
    #
    # Gives smaller classes higher importance.
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        for phase in ["train", "val"]:
            ...
            if phase == "train":
                ...
                # --------------------------------------------
                # Best model based on BALANCED ACCURACY
                # --------------------------------------------
...
def main():
    ...
    print("=" * 70)
    print("LUMINA — BUS-UCLM V2 TRAINING")
    print("=" * 70)
    ...
    print(
        "\nExisting UCLM V1 model will NOT be modified."
    )
